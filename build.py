...
CSS_LANDING = """
  ...
  .split-type{
    ...
    font-size:clamp(52px,12.5vw,186px);
  ...
  .split-mark{
    position:relative;z-index:3;margin:2.6vh auto;
    width:clamp(56px,7vw,96px);height:clamp(56px,7vw,96px);
  ...
  .split-runway{height:120svh;pointer-events:none}
